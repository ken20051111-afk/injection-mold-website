...
export const contentTypes: { type: ContentType; label: string; publicBase: string }[] = [
  { type: "capability", label: "Capabilities", publicBase: "/capabilities" },
  { type: "industry", label: "Industries", publicBase: "/industries" },
  { type: "caseStudy", label: "Case Studies", publicBase: "/case-studies" },
  { type: "post", label: "Blog Posts", publicBase: "/resources/blog" },
];
